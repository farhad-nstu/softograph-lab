<div class="card">
    ...
    <div class="card-body">
        <form id="card_documents_form" action="<?php echo e(route('cards.store_card_attachment')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\softolab\resources\views/layouts/pages/common/files/attachment_uploader.blade.php ENDPATH**/ ?>