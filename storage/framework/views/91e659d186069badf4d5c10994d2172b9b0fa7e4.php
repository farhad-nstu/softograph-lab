<script>
    ...
    $("#added_card_tasks").on("click", "button.card_task_edit_button", function () {
        ...
        axios
            .get("<?php echo e(route('cards.get_task_details')); ?>", {
                params: {
        ...
        bootbox.confirm({
            ...
            callback: function (confirmed) {
                if (confirmed) {
                    ...
                    axios.post("<?php echo e(route('cards.remove_card_task')); ?>", form_data, {})
                        .then(function (response) {
                            if (response.data.length <= 0) {
                                console.log("empty");
                                return false;
...
<?php /**PATH C:\xampp\htdocs\softolab\resources\views/layouts/pages/common/js/card_task_setter_js.blade.php ENDPATH**/ ?>