<script>
    function set_card_documents(card_documents) {
        home_url = "{{ url('/') }}";
        card_documents_download_url = "{{ url('card/documents/download') }}" + "?card_no=" + $('#card_id').val();
        ...
        for (card_document of card_documents) {
            ...
            let has_image = '';
            if (extension == 'pdf') {
                thumbnail = `<img src="{{ asset('img/pdf_icon.png') }}" alt="pdf_icon" class="img-thumbnail">`;
            } else {
                has_image = ' has_image';
                thumbnail = `
        ...
        bootbox.confirm({
            ...
            callback: function (confirmed) {
                ...
                if (confirmed) {
                    ...
                    axios.post("{{ route('cards.remove_card_attachment') }}", form_data, {})
